...
{
    public class $safeprojectname$Window : ConsoleWindow
    {
        /// <summary>
        /// Hello World !
        /// </summary>
        public $safeprojectname$Window() : base(40 * 16, 72 * 16, "$safeprojectname$")
        {
            // handle key events
            KeyDown += $safeprojectname$Window_KeyDown;
        ...
        /// <param name="e"></param>
        private void $safeprojectname$_KeyDown(object sender, KeyboardKeyEventArgs e)
        {
